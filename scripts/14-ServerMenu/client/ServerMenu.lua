...
function ServerMenu:LoadCategories()
	...
	self.leftlabel:SetSize( Vector2( ( textWidth2 + 30 ) * 4, 0 ) )
	...
	self.report_btn:SetMargin( Vector2( self.rightlabel:GetWidth() / 1.05 - Render:GetTextWidth( self.report_btn:GetText(), self.report_btn:GetTextSize() ), 5 ), Vector2( 0, 0 ) )
