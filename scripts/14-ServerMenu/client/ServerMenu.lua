...
function ServerMenu:LoadCategories()
	...
	self.report_btn:SetMargin( Vector2( self.rightcontainer:GetWidth() / 1.05 - Render:GetTextWidth( self.report_btn:GetText(), self.report_btn:GetTextSize() ), 5 ), Vector2( 0, 0 ) )
