...
function Abilities:SaveToDB(args, sender)
    ...
    if sender:GetValue("Wingsuit") then cmd:Bind(2, sender:GetValue("Wingsuit")) end
    if sender:GetValue("Boost") then cmd:Bind(3, sender:GetValue("Boost")) end
    if sender:GetValue("MoneyBonus") then cmd:Bind(4, sender:GetValue("MoneyBonus")) end
    if sender:GetValue("MoreC4") then cmd:Bind(5, sender:GetValue("MoreC4")) end
    if sender:GetValue("SuperNuclearBomb") then cmd:Bind(6, sender:GetValue("SuperNuclearBomb")) end
    if sender:GetValue("LongerGrapple") then cmd:Bind(7, sender:GetValue("LongerGrapple")) end
    if sender:GetValue("JesusModeEnabled") then cmd:Bind(8, sender:GetValue("JesusModeEnabled")) end
    cmd:Execute()
end
