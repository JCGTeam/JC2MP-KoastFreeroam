...
function Abilities:SetWindowVisible( visible, sound )
    ...
    if self.activeWindow then
        ...
        self.tip_title:SetText( self.locStrings["abilities"] ) self.tip_descrition:SetText( self.locStrings["noselected_description"] ) self.tip_descrition:SizeToContents()
