...
function SaveAndLoad:__init()
    ...
    for p in Server:GetPlayers() do
        self.playerTimes[p:GetId()] = {joinTime = os.time(), totalTime = p:GetValue("TotalTime") or 0}
    end
...
function SaveAndLoad:LoadStats(args)
    ...
    if #result > 0 then
        ...
        self.playerTimes[args.player:GetId()] = {joinTime = os.time(), totalTime = tonumber(result[1].totaltime)}
        ...
        self.playerTimes[args.player:GetId()] = {joinTime = os.time(), totalTime = 0}
    end
end
