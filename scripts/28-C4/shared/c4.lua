...
function C4:__init(WNO)
    ...
    table.insert(self.events, Events:Subscribe("PostTick", function() self:PostTick() end))
    ...
    if Client then
        ...
        table.insert(self.events, Events:Subscribe("Render", function() self:Render() end))
