...
function Nametags:CreateWindow()
    ...
    player_numeric:Subscribe("Changed", function()
    ...
    vehicle_numeric:Subscribe("Changed", function()
        self.vehicle_limit = vehicle_numeric:GetValue()
        self:UpdateLimits()
    end)
end

function Nametags:SetWindowVisible(visible)
    self:CreateWindow()
...
function Nametags:ToggleWindowVisible()
