...
function Shop:LoadCategories()
	...
	self.locStrings["vehiclecolor"] = nil
	self.locStrings["save"] = nil
	self.locStrings["sethomebutton"] = nil
	self.locStrings["spawnonhomepoint"] = nil
	self.locStrings["gohome"] = nil
end
