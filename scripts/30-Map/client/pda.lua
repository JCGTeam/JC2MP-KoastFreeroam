...
function PDA:ExtractionSequence()
	...
	if not self.world_fadeout_timer and not self.world_fadein_timer and not self.teleporting and not self.loading and not extraction_timer and not self.map_fadeout_timer then
