...
function GameModesMenu:CreateWindow()
	...
	self.mainButton.carbattles = self:CreateGameModesMenuButton( self.mainButton.scroll_gm, "Бои на тачках", self.carbattlesimage, "Сражайтесь и выживайте на тачках.", self.mainButton.hunt:GetPosition().x + textWidth + 15, self.CarBattlesToggle )
	self.mainButton.race = self:CreateGameModesMenuButton( self.mainButton.scroll_gm, "Гонки", self.raceimage, "Доберитесь первым до финиша среди прочих гонщиков.", self.mainButton.carbattles:GetPosition().x + textWidth + 15, self.RaceToggle )
	self.mainButton.tron = self:CreateGameModesMenuButton( self.mainButton.scroll_gm, "Трон", self.tronimage, "Заманивайте других игроков в свою полосу, чтобы одержать победу.", self.mainButton.race:GetPosition().x + textWidth + 15, self.TronToggle )
	self.mainButton.khill = self:CreateGameModesMenuButton( self.mainButton.scroll_gm, "Царь горы", self.kinghillimage, "Доберитесь первым до вершины горы, чтобы одержать победу.", self.mainButton.tron:GetPosition().x + textWidth + 15, self.KHillToggle )
	self.mainButton.derby = self:CreateGameModesMenuButton( self.mainButton.scroll_gm, "Дерби", self.carbattlesimage, "Ушатывайте машины других игроков стараясь выжить сами.", self.mainButton.khill:GetPosition().x + textWidth + 15, self.DerbyToggle )
	...
	self.mainButton.tetris_IMG:SetHeight( textWidth / 1.2 )
	self.mainButton.tetris_IMG:SetWidth( textWidth / 1.2 )
	...
	self.mainButton.tetris:SetHeight( textWidth * 1.25 / 1.15 )
	...
	self.mainButton.pong_IMG:SetPosition( Vector2( self.mainButton.tetris_IMG:GetPosition().x + textWidth / 1.2 + 15, 0 ) )
	self.mainButton.pong_IMG:SetHeight( textWidth / 1.2 )
	self.mainButton.pong_IMG:SetWidth( textWidth / 1.2)
	...
	self.mainButton.pong:SetHeight( textWidth * 1.25 / 1.15 )
	...
	self.mainButton.casino_IMG:SetPosition( Vector2( self.mainButton.pong_IMG:GetPosition().x + textWidth / 1.2 + 15, 0 ) )
	self.mainButton.casino_IMG:SetHeight( textWidth / 1.2 )
	self.mainButton.casino_IMG:SetWidth( textWidth / 1.2)
	...
	self.mainButton.casino:SetHeight( textWidth * 1.25 / 1.15 )
