...
function ModernGUI.Button.Create( parent )
    ...
    button:Subscribe( "HoverEnter", function() Animation:Play( defaultAlpha, hoverAlpha, hoverSpeed, easeIOnut, function( value ) if IsValid( background ) then background:SetColor( Color( defaultColor.r, defaultColor.g, defaultColor.b, value ) ) end end ) end )
    button:Subscribe( "HoverLeave", function() Animation:Play( hoverAlpha, defaultAlpha, hoverSpeed, easeIOnut, function( value ) if IsValid( background ) then background:SetColor( Color( defaultColor.r, defaultColor.g, defaultColor.b, value ) ) end end ) end )
    button:Subscribe( "Press", function() Animation:Play( 0, hoverAlpha, hoverSpeed, easeIOnut, function( value ) if IsValid( background ) then background:SetColor( Color( defaultColor.r, defaultColor.g, defaultColor.b, value ) ) end end ) end )
...
function ModernGUI.TextBox.Create( parent )
    ...
    textBox:Subscribe( "HoverEnter", function() Animation:Play( defaultAlpha, hoverAlpha, hoverSpeed, easeIOnut, function( value ) if IsValid( background ) then background:SetColor( Color( defaultColor.r, defaultColor.g, defaultColor.b, value ) ) end end ) end )
    textBox:Subscribe( "HoverLeave", function() Animation:Play( hoverAlpha, defaultAlpha, hoverSpeed, easeIOnut, function( value ) if IsValid( background ) then background:SetColor( Color( defaultColor.r, defaultColor.g, defaultColor.b, value ) ) end end ) end )
